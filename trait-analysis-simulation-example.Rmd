...
```{r}
plot( indXtraits_rda, type='none', scaling = 1)
points( indXtraits_rda, pch=20, cex=0.8, scaling = 1)
text(indXtraits_rda,display='species',col='red',axis.bp=TRUE, scaling = 1)
text(indXtraits_rda,display='bp', scaling = 1)
```
