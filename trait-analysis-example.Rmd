...
l_coa <- dudi.coa(pXs_forCWM, scannf = FALSE)

## PCA of the R and Q data tables
r_pca <- dudi.pca(bk_cwm_traits_env[env_vars], row.w = l_coa$lw, scannf = FALSE)
q_pca <- dudi.pca(tXs_forCWM, row.w = l_coa$cw, scannf = FALSE)
...
plot(bk_fourthcorner, alpha = 0.05)
...
plot(bk_fourthcorner_pa, alpha = 0.05)
